		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<br />
					<div class="para1">
						<div>With registration with us new world of fashion,fantastic
							discounts and much more opens</div>
						<div>to you! The whole process will not take you more than a
							minute!</div>
						<br />
					</div>
				...
				<div class="col-sm-4">
					...
					<br />
					<div class="para1">
						<div>If you have any questions, please feel free to contact
							us, our customer service center is working for you 24/7.
						</div>
						<br />
					</div>
